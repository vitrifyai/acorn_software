...
def _params_from_clu(params: dict) -> dict:
    ...
    return {
        ...
        "max_tilt_deg": _first_float(params, ("max_tilt_deg", "spore_tilt_deg",
                                              "tilt_deg"), 0.0),
        "stacking": _first_float(params, ("stacking", "pileup", "pile_up"), 0.0),
        "debris_clumps": int(params.get("debris_clumps", params.get("debris", 0))),
        "debris_grain_nm": _first_float(params, ("debris_grain_nm",), 70.0),
        "debris_spread_nm": _first_float(params, ("debris_spread_nm",), 1200.0),
        "E0_kev": kv,
        ...
        "shadowing": _first_float(params, ("shadowing", "shadows"), 0.0),
